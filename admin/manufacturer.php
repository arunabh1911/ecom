...
<script type="text/javascript" src="js/custom/tables.js"></script>
  ...
  <span id="test"></span>  
        <div class="pageheader notab">
            <h1 class="pagetitle">Manufacturer List</h1>
          
<form  method="post" >
&nbsp;&nbsp;&nbsp;&nbsp;
<button class="submit radius2" onclick="window.location='manufacturer-add.php'; return false;">Add Manufacturer</button>
</form>
        </div><!--pageheader-->
     ...
     <th width="20" class="head1 aligncenter"><input type="checkbox" name="checkall" class="checkall" /></th>
                    ...
                    <tbody>
<?
@$sql = $db->runQuery("SELECT * FROM ".MANU." ORDER BY id DESC");
...
<a href="manufacturer-add.php?id=<?=$view['id']?>" class="btn btn4 btn_search" title="view record"></a>
<!--<a href="#" id="<?=$view['id']?>" tbl="<?=MANU;?>" class="btn btn4 btn_trash delete" title="delete record"></a>-->
