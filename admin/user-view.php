<? 
include'header.php';
$user = $db->getQuery($db->runQuery("select *, u.status as status from ".USERS." as u join ".ADDRESS." as a on u.userId = a.userId where u.userId = '".$_REQUEST['userId']."' "));
  ...
  <div id="general" class="subcontent">	
        ...
        <p>
            <label>Registration Date</label>
             <span class="field">
             <span><?=date('d M Y',strtotime($user['date']));?></span>
            </span>
        </p>          
