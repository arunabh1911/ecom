...
if(@$_REQUEST['id'])
{
	$data = $db->getQuery($db->runQuery("select * from ".PAR." where id = '".$_REQUEST['id']."' "));
}
?>
...
function val()
{
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">
              <? if(@$_REQUEST['id']) echo 'Edit'; else echo 'Create'; ?>
             Parameters</h1>
...
<? }?>
                  <p class="stdformbutton">
                        ...
                        <input type="hidden" name="admin" value="parameter-add" />
                        <? }else{?>
                         <button class="submit radius2">&nbsp;&nbsp;Update &nbsp;&nbsp;</button>
                        <input type="hidden" name="admin" value="parameter-edit" />
