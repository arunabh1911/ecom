...
************************************************************************************************************/	
	...
	function chooseColor()
	{
		...
		//document.getElementById(name1).value= this.getAttribute('rgbColor');
		
		var ctrl= color_picker_active_input;
		var list = document.getElementById("menu").getElementsByTagName('a');
		var str= this.getAttribute('rgbColor');
		
		var user= str.slice(1,  str.length);
		
		
		ctrl.innerHTML='Pick Color <input name="color[]" value="'+this.getAttribute('rgbColor')+'" type="hidden" /><a href="javascript:void(0)" class="nactive" style="background:'+this.getAttribute('rgbColor')+'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>';
	...
	function showColorPicker(inputObj,formField,names)
	{
