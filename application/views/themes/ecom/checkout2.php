...
<script>
function inv() {
var group = document.getElementsByName('pMode')
  ...
  <div id="">
    ...
    <table id="" class="tblCheckoutProcess">
      <tr id="">
        ...
        <td id=""><img id="" src="<?=temp_path?>/img/Arrow.jpg" alt=" > " /></td>
        <td id=""><a id="" class="complete">Shipping</a></td>
        <td id=""><img id="" src="<?=temp_path?>/img/Arrow.jpg" alt=" > " /></td>
        <td id=""><a id="" class="current">Billing</a></td>
        <td id=""><img id="" src="<?=temp_path?>/img/Arrow.jpg" alt=" > " /></td>
    ...
    <div id="">
      <div>
		...
		<form action="" id="form_inline" method="post" onsubmit="return inv()">
...
<? $naam = explode(' ',$user->name); ?>      
     ...
     <input name="userId" id="userId" type="hidden" value="<?=$user->userId?>" > 
		 <input name="addtype" type="hidden" value="billing" > 
		 <input name="goto" type="hidden" value="gateway" > 
